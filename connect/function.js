...
function arielRandom(indah) {
  return indah[Math.floor(Math.random() * indah.length)]
}  
...
module.exports = { getBuffer, getRandom, fetchJson, arielRandom, runtime, chalk, color, bgcolor, ConsoleLog, webp2mp4File, igDownloader, mediafireDl, igstalk, pickRandom, randomInt, genMath}